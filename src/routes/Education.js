    ...
    return (
      <div class="flex h-screen">
        ...
        <div class="bg-orange-400 basis-10/12 rounded shadow ">
          <h1 class="p-3 uppercase font-bold font-serif text-4xl">Education</h1>
          <div>
          <ul>
                    <li> 
                        <div>
                    ...
                    <li> 
                        ...
                        <h5>
                        Related courseworks: <span>Analysis of Circuit, Instrumentation and Measurement, Introduction to Management,
                        ...
                        Thermodynamics and Heat Transfer</span>
                        </h5>
                    </li>
                    <li> 
                        <div >

    ...
    return (
      <div class="flex h-screen">
        ...
        <div class="bg-orange-400 basis-10/12 rounded shadow ">
          <h1 class="p-3 uppercase font-bold font-serif text-4xl">Careers</h1>
          <div>
          <ul>
                    <li>
                        <div>
                    ...
                    <li>
                        ...
                        <ul>
                            ...
                            <li>    
                                Identified and resolved 10 web application vulnerabilities with high and medium risks to improve reliability and enhance security.
                            </li>
                        </ul>
                    </li>
                </ul>
